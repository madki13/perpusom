...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2022 at 09:38 AM
...
--
-- Table structure for table `bibliography_author`
--
...
--
-- Table structure for table `bibliography_category`
--
...
--
-- Indexes for table `bibliography_author`
--
ALTER TABLE `bibliography_author`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bibliography_category`
--
...
--
-- AUTO_INCREMENT for table `bibliography_author`
--
ALTER TABLE `bibliography_author`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bibliography_category`
--
ALTER TABLE `bibliography_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
